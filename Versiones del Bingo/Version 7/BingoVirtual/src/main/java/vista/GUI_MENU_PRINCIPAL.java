...
public class GUI_MENU_PRINCIPAL extends javax.swing.JFrame {
  private static ArrayList<CartonBingo> cartonesAcuales = new ArrayList<CartonBingo>();
  private static List<Jugador> jugadoresTotales = new ArrayList<Jugador>();
    ...
    public GUI_MENU_PRINCIPAL() {
        ...
        btn_RegistrarJugador.addActionListener((ActionEvent e) -> {
            // Crea una instancia de la nueva ventana y hazla visible
            GUI_Juego RegistrarJugador = new GUI_Juego();
    ...
    public ArrayList<CartonBingo> getCartonesActuales() {
    
      return GUI_MENU_PRINCIPAL.cartonesAcuales;
    } 
    
    public static List<Jugador> getJugadores() {
    
      return GUI_MENU_PRINCIPAL.jugadoresTotales ;
    }
    
    
    public static void  setCartonesActuales(ArrayList<CartonBingo> pCartones) {
    
      GUI_MENU_PRINCIPAL.cartonesAcuales = pCartones;
    } 
    
    public static void setJugadores(List<Jugador> pJugador) {
    
      GUI_MENU_PRINCIPAL.jugadoresTotales = pJugador;
    }
    
    
    
    
    public static void jugadoresRegistrados() {
